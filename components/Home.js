...
// poster: data.movies.results[i].poster_path,
...
function Home() {
  ...
  useEffect(() => {
    fetch('https://mymoviz-backend-puce-alpha.vercel.app/movies')
 ...
 //console.log('je suis en dehors l45')
  }, []);
